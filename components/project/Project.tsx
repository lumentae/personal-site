        ...
        <div>
          <div className="flex justify-between w-full">
            ...
            <p className="text-xl flex">
              {props.stars ?? 0}{" "}
              <StarIcon size={iconSize} className="ml-1 mt-1" />
            </p>
          </div>
        ...
        <div className="flex flex-col mt-4 gap-2">
          {props.repoUrl && (
            <div className="flex text-base gap-2">
              ...
              <a
                target="_blank"
                className="hover:underline text-sm darken underline hover:opacity-80 transition-opacity"
                href={props.repoUrl}
              >
                GitHub
              </a>
          ...
          <div className="flex flex-wrap gap-2 mt-1 text-sm items-center">
            ...
            {props.forks !== undefined && (
              <>
                ...
                <span>
                  {props.forks} {props.forks === 1 ? "Fork" : "Forks"}
                </span>
                {(props.issues !== undefined || props.license) && (
                  <VerticalDivider />
                )}
              </>
            )}
            {props.issues !== undefined && (
              <>
                ...
                <span>
                  {props.issues} {props.issues === 1 ? "Issue" : "Issues"}
                </span>
                {props.license && <VerticalDivider />}
              </>
            )}
